...
-- DELETE FROM IB_OM_RULE_INFO WHERE RULE_NO = '090314';
-- DELETE FROM IB_OM_RULECOND_INFO WHERE OPRTN_COND_NO = 'CI90314';
-- DELETE FROM IB_OM_RULECOND_RLT WHERE RULE_COND_NO = 'CI90314';
-- DELETE FROM IB_OM_MODE_INFO WHERE RULE_MODE_NO = 'CI90314';
...
('090314','CI','N','1','TE','0000','*,','00303007','批量导入','1','900001','2020-02-25','批量新增');
...
('CI90314','subAccIsTD','==','1','','','00303007','子账户类型是否定期','900001','2020-02-25','批量新增','1','0','子账户类型是否定期'),
('CI90314','Isadvance','==','1','','','00303007','是否提前支取','900001','2020-02-25','批量新增','1','0','是否提前支取');
...
('CI90314','1','ref','custom-selector_6','CI'),
('CI90314','2','NI','1','CI'),
('CI90314','3','FR','0','CI'); 