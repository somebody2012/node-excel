...
('095000','CI','N','1','TE','0000','*,','00301012','批量导入','1','900001','2020-03-21','批量新增'),
('095001','CI','N','1','TE','0000','*,','00303007','批量导入','1','900001','2020-03-21','批量新增');
...
('CI95000','txAmt','>=','10000','','','00301012','交易金额','900001','2020-03-21','批量新增','1','0','交易金额'),
('CI95001','Isadvance','==','1','','','00303007','是否提前支取','900001','2020-03-21','批量新增','1','0','是否提前支取');
...
('CI95000','1','ref','custom-input_pasbNum','CI'),
('CI95000','2','NI','1','CI'),
('CI95000','3','FR','0','CI'),
('CI95001','4','ref','custom-selector_6','CI'),
('CI95001','5','NI','1','CI'),
('CI95001','6','FR','0','CI');