...
('070000','CK','N','1','TE','9999','*,','00302016','需要复核','1','','2019-08-17','批量新增'),
('070001','CK','N','1','TE','9999','*,','00302017','需要复核','1','','2019-08-17','批量新增'),
('070002','CK','N','1','TE','9999','*,','00306004','需要复核','1','','2019-08-17','批量新增'),
('070003','CK','N','1','TE','9999','*,','00306006','需要复核','1','','2019-08-17','批量新增'),
('070004','CK','N','1','TE','9999','*,','00306001','需要复核','1','','2019-08-17','批量新增');
...
('CK70000','isCheck','==','1','','','00302016','需要复核','','2019-08-17','批量新增','1','0',''),
('CK70001','isCheck','==','1','','','00302017','需要复核','','2019-08-17','批量新增','1','0',''),
('CK70002','isCheck','==','1','','','00306004','需要复核','','2019-08-17','批量新增','1','0',''),
('CK70003','isCheck','==','1','','','00306006','需要复核','','2019-08-17','批量新增','1','0',''),
('CK70004','isCheck','==','1','','','00306001','需要复核','','2019-08-17','批量新增','1','0','');
