...
var currencyCond = [
  {
    ...
    // 现金 授权类型 授权级别	现金起始金额	现金限制金额
    cash:[
      // [0,	0,	50000],
      [1,2,	50000,	200000],
      [1,3,	200000,	1000000],
      [3,4,	1000000,	2000000],
      [3,5,	2000000,	20000000],
      [3,6,	20000000,	50000000],
      [3,7,	50000000,	100000000],
      [3,8,	100000000,	200000000],
      [3,9,	200000000,	400000000],
      [3,9,	400000000,	10000000000000000],
    ],
    // 人脸识别不通过 生成条件
    ...
    transfer:[
      ...
      [1,4,	1000000,	  2000000],
      [3,4,	2000000,	  4000000],
      [3,5,	4000000,	  40000000],
      [3,6,	40000000,	  100000000],
      [3,7,	100000000,	200000000],
      [3,8,	200000000,	400000000],
      [3,9,	400000000,	800000000],
      [3,9,	800000000,	10000000000000000],
    ]
  },
  {
    Ccy:"840",
    ...
    cash:[
      ...
      [1,6,200000,500000],
      [1,7,500000,1000000],
      [1,8,1000000,20000000],
      [1,9,20000000,40000000],
      [1,9,	400000000,	10000000000000000],
    ],
    // 人脸识别不通过 生成条件
    ...
    transfer:[
      ...
      [1,6,400000,1000000],
      [1,7,1000000,2000000],
      [1,8,2000000,40000000],
      [1,9,40000000,80000000],
      [1,9,	800000000,	10000000000000000],
    ]
  },
  {
    Ccy:"392",
    ...
    cash:[
      [1,3,100000,500000],
      [1,4,500000,2000000],
      [1,5,2000000,20000000],
      [1,6,20000000,50000000],
      [1,7,50000000,100000000],
      [1,8,100000000,2000000000],
      [1,9,2000000000,4000000000],
      [1,9,	400000000,	10000000000000000],
    ],
    // 人脸识别不通过 生成条件
    transferFaceNotPassedIndex:[],
    ...
    transfer:[
      [1,3,500000,1000000],
      [1,4,1000000,4000000],
      [1,5,4000000,40000000],
      [1,6,40000000,100000000],
      [1,7,100000000,200000000],
      [1,8,200000000,4000000000],
      [1,9,4000000000,8000000000],
      [1,9,	800000000,	10000000000000000],
    ]
  },
  {
  ...
  },
  {
    ...
    cash:[
      ...
      [1,5,200000,2000000],
      [1,6,2000000,5000000],
      [1,7,5000000,10000000],
      [1,8,10000000,200000000],
      [1,9,200000000,400000000],
      [1,9,	400000000,	10000000000000000],
    ...
    transfer:[
      ...
      [1,4,100000,400000],
      [1,5,400000,4000000],
      [1,6,4000000,10000000],
      [1,7,10000000,20000000],
      [1,8,20000000,400000000],
      [1,9,400000000,800000000],
      [1,9,	800000000,	10000000000000000],
    ]
  },
  {
...
class GenAmtCond{
  ...
  // 生成金额模式条件映射
  genAmtModeCondRlt(){
    let AMT_RULE_NO = config.AMT_RULE_NO;
    for(let i=1;i<this.authModeData.length;i++){
      let MODE_NO = this.authModeData[i][0];
      let ruleCondData = [MODE_NO,"1",AMT_RULE_NO];
      this.ruleCondData.push(ruleCondData);
    }
  }
}
