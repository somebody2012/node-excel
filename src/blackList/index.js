...
class BlackList {
  ...
  generateRuleInfoData(RULE_NO,curSheetRow){
    ...
    var SUIT_LPR_SCP = curSheetRow[4] || "*";  // 适用法人范围
...
let deleteAll = `\n
DELETE FROM IB_OM_RULE_INFO WHERE RULE_NO BETWEEN '065000' AND '069000';
DELETE FROM IB_OM_RULECOND_INFO WHERE OPRTN_COND_NO BETWEEN 'BN65000' AND 'BN69000';
DELETE FROM IB_OM_MODE_INFO WHERE RULE_MODE_NO BETWEEN 'BN65000' AND 'BN69000';
DELETE FROM IB_OM_RULECOND_RLT WHERE OPRTN_RULE_NO BETWEEN '065000' AND '069000';
\n
`;
